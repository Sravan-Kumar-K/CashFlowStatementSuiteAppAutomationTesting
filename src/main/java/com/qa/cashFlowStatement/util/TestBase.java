package com.qa.cashFlowStatement.util;
...
import com.qa.cashFlowStatement.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener{
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\CashFlowStatementAutomationTesting\\src\\main\\java\\com\\qa\\cashFlowStatement\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
